...
RUN pip3 install --no-cache-dir --upgrade pip && pip3 install --no-cache-dir vllm==0.15.0 runpod huggingface_hub pillow requests python-magic && apt-get clean && rm -rf /root/.cache
